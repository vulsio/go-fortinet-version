...
// components render in normalized decimal form (leading zeros dropped: "07" ->
// "7"); milestone letters render as-is, and whole trailing-zero components are
// preserved, so 7.2 and 7.2.0 render differently even though they compare equal.
